...
namespace GoogleARCore.Examples.HelloAR {
    ...
    /// </summary>
    public class SingleARController : MonoBehaviour {
        /// <summary>
        ...
        // 새로 추가한 부분
        private GameObject JangField;
        private bool fieldFlag = false;
        public GameObject SingleGameDirector;
        public GameObject SingleButtons;
        PublicVariable publicVariable;
        //public Button MaSangButton;
        // 여기까지 추가
            ...
            if (!fieldFlag) {
                ...
                if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit)) {
                    ...
                    if ((hit.Trackable is DetectedPlane) &&
                        ...
                        fieldFlag = true;
                        SingleGameDirector.SetActive(true);
